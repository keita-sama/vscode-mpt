...
export class YuriPreview {
    ...
    public static render(context: vscode.ExtensionContext) {
        ...
        if (YuriPreview.currentPanel) {
            YuriPreview.currentPanel._panel.reveal(vscode.ViewColumn.Two);
        } else {
            const panel = vscode.window.createWebviewPanel('yuri-preview', 'Previewing: Yuri', vscode.ViewColumn.Two, {
                enableScripts: true,
            });
    ...
    public dispose() {
        YuriPreview.currentPanel = undefined;
        this._panel.dispose();
    ...
    private _getWebviewContent(webview: vscode.Webview, extensionUri: vscode.Uri) {
        ...
        const stateUri = webview.asWebviewUri(vscode.Uri.parse(`${extensionUri}/scripts/yuri/state.js`));
        const handlerUri = webview.asWebviewUri(vscode.Uri.parse(`${extensionUri}/scripts/yuri/handler.js`));
