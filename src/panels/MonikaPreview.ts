...
export class MonikaPreview {
    public static currentPanel: MonikaPreview | undefined;
                ...
                case 'image_path':
                    this._panel.webview.postMessage({
                        ...
                        data: this._panel.webview
                            .asWebviewUri(
                                vscode.Uri.file(
                                    vscode.workspace.getConfiguration('vscode-mpt').workingMPTPath + '/monika'
                                )
                            )
                            .toString(),
                    });
    ...
    public static render(context: vscode.ExtensionContext) {
        ...
        if (MonikaPreview.currentPanel) {
            MonikaPreview.currentPanel._panel.reveal(vscode.ViewColumn.Two);
        } else {
    ...
    public dispose() {
        MonikaPreview.currentPanel = undefined;
        this._panel.dispose();
    ...
    private _getWebviewContent(webview: vscode.Webview, extensionUri: vscode.Uri) {
        ...
        const stateUri = webview.asWebviewUri(vscode.Uri.parse(`${extensionUri}/scripts/monika/state.js`));
        const handlerUri = webview.asWebviewUri(vscode.Uri.parse(`${extensionUri}/scripts/monika/handler.js`));
