...
export class NatsukiPreviewPanel {
    public static currentPanel: NatsukiPreviewPanel | undefined;
    ...
    public static render(extensionUri: vscode.Uri) {
        if (NatsukiPreviewPanel.currentPanel) {
            ...
            NatsukiPreviewPanel.currentPanel = new NatsukiPreviewPanel(
                panel,
                extensionUri
            );
        }
    ...
    public dispose() {
        NatsukiPreviewPanel.currentPanel = undefined;
        this._panel.dispose();
    ...
    private _getWebviewContent(
        ...
        const stateUri = webview.asWebviewUri(
            vscode.Uri.parse(`${extensionUri}/src/scripts/natsuki/state.js`)
        );
        const handlerUri = webview.asWebviewUri(
            vscode.Uri.parse(`${extensionUri}/src/scripts/natsuki/handler.js`)
        );
